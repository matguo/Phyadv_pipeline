...
| **ScienceDirect** | `("adversarial attack" OR "adversarial example" OR "adversarial patch") AND ("physical" OR "real world") AND ("camouflage" OR "optical" OR "light" OR "illumination" OR "laser" OR "infrared" OR "camera" OR "sensor")` | Title, Abstract, Keywords (via dropdown) | 152 | Field limited to Title, Abstract, and Keywords via advanced search dropdown menu |
| **Springer** | `("adversarial attack" OR "adversarial example" OR "adversarial patch") AND ("physical" OR "real world") AND ("camouflage" OR "optical" OR "light" OR "illumination" OR "laser" OR "infrared" OR "camera" OR "sensor")` | Title, Abstract, Keywords | 1233 |Field limited to Title ，Abstract, Keywords via advanced search dropdown menu |
